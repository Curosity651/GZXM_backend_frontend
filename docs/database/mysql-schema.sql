...
CREATE TABLE progress_report (
  ...
  research_achievements TEXT NOT NULL,
...
CREATE TABLE file_object (
  id BIGINT UNSIGNED PRIMARY KEY AUTO_INCREMENT,
  storage_provider VARCHAR(32) NOT NULL DEFAULT 'FILESYSTEM' COMMENT 'FILESYSTEM/MINIO/S3',
...
-- 成果动作/审批成功请求重放增量：backend/src/main/resources/db/migration/V202609160930__add_achievement_workflow_operations.sql
