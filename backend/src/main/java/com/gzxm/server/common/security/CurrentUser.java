...
public record CurrentUser(long id, String username, String principalName, String contactName, Long unitId, String unitName, String roleCode,
    ...
    public CurrentUser(long id, String username, Long unitId, String roleCode,
        ...
        this(id, username, username, username, unitId, null, roleCode, authorities, memberships, tokenVersion);
    }
