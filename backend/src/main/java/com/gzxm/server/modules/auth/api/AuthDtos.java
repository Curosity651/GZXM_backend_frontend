...
public final class AuthDtos {
    ...
    public record CurrentUserView(String id, String username, String principalName, String contactName, String unitId, String unitName, String roleCode,
        ...
        public static CurrentUserView from(CurrentUser user) {
            ...
            return new CurrentUserView(String.valueOf(user.id()), user.username(), user.principalName(), user.contactName(),
