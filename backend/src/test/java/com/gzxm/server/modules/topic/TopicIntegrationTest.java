...
class TopicIntegrationTest {
    ...
    void flywayAndRuntimeOpenApiContainTopicModule() throws Exception {
        assertThat(jdbc.queryForObject("SELECT COUNT(*) FROM flyway_schema_history WHERE success=1 AND version IN ('202609150900','202609160100','202609160200')", Integer.class)).isEqualTo(3);
